...
import { ArrowLeft, FileText, Printer, Download, Loader2, Trash2 } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <AlertDialog open={showDeleteConfirm} onOpenChange={setShowDeleteConfirm}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>¿Eliminar cotización {quote.quoteNumber}?</AlertDialogTitle>
            <AlertDialogDescription>
              Esta acción eliminará la cotización de {quote.client.name} por {formatCurrency(quote.total)} junto con todos sus items. No se puede deshacer.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
